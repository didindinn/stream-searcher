...
import { INITIAL_STATE, TWITCH_API_PATH, TWITCH_LANGUAGES, MIN_STREAMS_PER_PAGE, TWITCH_AUTH_PATH, TWITCH_AUTH_PARAMS } from './utils/constants';
    ...
    return (
      <div>
        ...
        <div className={filtersClass}>
          ...
          <div className="filters">
            ...
            <div className="github__container">
              <a className="github__link" href="https://github.com/Keylies/stream-searcher" target="__blank" >Stream Searcher on <span className="github">GitHub</span></a>
            </div>
          </div>
        ...
        <header>
          ...
          {!this.state.logged ? (
            <button onClick={this.login} className="user__button" title="Authenticate to increase requests limit">
